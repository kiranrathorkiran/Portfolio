        ...
        <div className="flex flex-col items-center md:space-x-12">
          <div className="flex-1">
            ...
            I'm a passionate web developer who loves
                            crafting interactive and user-friendly websites. With expertise in frontend and backend
                            technologies, I turn ideas into reality using clean and efficient code. Let's build
            ...
            <div className="flex justify-center items-center space-x-6 my-8">
              <a href="https://www.linkedin.com/in/kiran-rathor-837890284/" target="_blank" rel="noopener noreferrer"
                className="transform transition-transform duration-300 hover:scale-105">
                <img src={LinkedInImage} alt="LinkedIn" className="w-10 h-10" />
              </a>
              <a href="https://github.com/kiranrathorkiran" target="_blank" rel="noopener noreferrer"
                className="transform transition-transform duration-300 hover:scale-105">
                <img src={GitHubImage} alt="GitHub" className="w-10 h-10 filter brightness-100 dark:brightness-100" />
              </a>
              <a href="mailto:kiranrathor8085@gmail.com"
                className="transform transition-transform duration-300 hover:scale-105">
                <img src={MailImage} alt="Email" className="w-10 h-10" />
              </a>
              <a href="https://www.geeksforgeeks.org/user/kiranrat7ca8/" target="_blank" rel="noopener noreferrer"
                className="transform transition-transform duration-300 hover:scale-105">
                <img src={GeeksforGeeksImage} alt="GeeksforGeeks" className="w-10 h-10" />
              </a>
              <a href="https://leetcode.com/u/kiranrathor/" target="_blank" rel="noopener noreferrer"
                className="transform transition-transform duration-300 hover:scale-105">
